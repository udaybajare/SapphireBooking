...
public class LoginController {
	...
	public static final String showPriceList = "<form id=\"updatePriceList\" action=\"showPriceList\" method=\"GET\"><img src=\"images/img/upadtePrice.png\" alt=\"\" width=\"170\" height=\"170\" onClick=\"$('#updatePriceList').submit();\"> <button type=\"button\" class=\"btn btn-sm btn-default\" onClick=\"$('#updatePriceList').submit();\" style=\"margin-top: 14%;margin-left: 12%\">View/Update Price List</button></form>";
}