        ...
        <div class="container">
          <div class="row justify-content-lg-center">
            ...
            <div class="main col-lg-6 pv-40">
              <h1 class="page-title medium"><span class="text-default">Order Submitted</span></h1>
              <p class="lead">Thanks You!! Your order has been submitted. Our representative will get back to you for more details.</p>
            </div>
            <!-- main end -->
